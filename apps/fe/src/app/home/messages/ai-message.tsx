  ...
  return (
    ...
    >
      <div
        ...
        className="relative inline-flex h-10 w-10 scale-90 items-center justify-center overflow-hidden rounded-full bg-gray-200 outline outline-offset-2 outline-gray-600 dark:bg-gray-600"
      >
